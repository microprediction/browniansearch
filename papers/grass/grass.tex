...
and loses on smooth low-dimensional ones.
\end{abstract}
...
to Brent. It loses to the
classical loops on smooth low-dimensional objectives, and it loses
badly on needle landscapes, where the value hides in a spike and no
placement theory helps. Across the 22 objectives the rule ranks
