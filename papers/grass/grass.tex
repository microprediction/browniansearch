...
rivals, however, decides nothing by itself: the exterior player may
choose any correlation, an observed anchor may be kept, and above all
a matched-mean exterior point must exist. Mean reversion caps the
conditional mean of every unvisited location, and when the anchors are
high enough that cap binds. The next section makes this exact.
...
supremum $b$, unattained, while the best exterior point offers
$\sup_{\lambda\in[0,1)}\left[b\lambda
+\tfrac12\left(1-\lambda^{2}\right)\right]<b$ for $b>1$: staying at
an anchor wins. If $\sinh 2\tau<b<e^{2\Theta}$ the interior optimum
...
$d\in\left(0.4715,\,1\right)$: below, the ray past the better end
...
$0.3$ & $0.167$ & $0.8722$ & $0.8692$ & $0.31\%$ \\
$0.5$ & $0.289$ & $0.9386$ & $0.9314$ & $0.73\%$ \\
$0.7$ & $0.402$ & $1.0375$ & $1.0271$ & $1.05\%$ \\
$0.83$ & $0.469$ & $1.1183$ & $1.1072$ & $1.11\%$ \\
...
the prescription that errs, and it errs exactly when both evaluations
came in high.

\section{Discussion}

The proverb, read as mathematics, is conditional. Jensen's inequality
upgrades any unvisited location whose conditional mean matches a
visited one --- by half its variance under the exponential payoff, and
in the convex order generally, at the constant amplification
$e^{2\Theta}$ of Theorem~\ref{thm:dominance}. But the inequality does
not manufacture such locations. Mean reversion caps the conditional
...
inherited by the refinement phase. The bridge formulas make each
...
adaptive optimization --- and places it nearer to the economic search
tradition of Callander, in which each trial is a policy actually
enacted and the last choice is the one lived with. The three-shot
phase diagram, the constant variance amplification $e^{2\Theta}$, and
the constrained parabola \eqref{eq:parabola} are, to our knowledge,
new in either setting.
