...
this out: on 34 further HumpDay pages held out from the objectives
...
0.45, one-sided $p=0.004$; 0.51 with the single highest-count page,
which runs against the pattern, removed). Scripts, seeds, the
