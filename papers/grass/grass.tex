...
the prescription that errs, and it errs when both evaluations land in
the revisit window --- high, but below the ceiling $e^{2\Theta}$
above which both policies stay.
