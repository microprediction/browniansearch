...
Unit variance is a calibration, not a normalization. With payoff
$e^{\beta X}$ on a unit-variance path, every comparison maximizes
$\mu + \beta\nu/2$; the two-shot step becomes
$\lambda^{*}=\operatorname{clip}(b/\beta,0,1)$, and the pitchfork
and ceiling of Section~7 scale to $\beta\cdot 2\sqrt{\rho}/(1-\rho)$
and $\beta(1+\rho)/(1-\rho)$. Comparative statics in $\beta$ follow
directly, and the one-percent figure of Section~9 is specific to
$\beta=1$.
