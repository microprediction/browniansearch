...
$\rho$ the bracket correlation: stay between the anchors on good news;
on bad news step out past the better end, whichever end that is.
...
analysis says when it truly is. On bad news, leave: a below-median
